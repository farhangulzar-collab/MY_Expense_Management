...
def add_update_tab():
    selected_date = st.date_input("Enter a Date:", datetime(2024, 8, 1), label_visibility="collapsed")
    ...
    with st.form(key="expense_form"):
        ...
        for i in range(5):
            ...
            col_1, col_2, col_3 = st.columns(3)
            with col_1:
                amount_input = st.number_input("Amount", min_value=0.0, step=1.0, value=float(amount),
            ...
            expenses.append(
                {"category": category_input, "amount": amount_input, "notes": notes_input})
